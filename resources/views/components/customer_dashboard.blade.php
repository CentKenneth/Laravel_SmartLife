        ...
        <div class="flex h-16 items-center justify-between">
          <div class="flex items-center">
            ...
            <div class="ml-10 flex items-baseline space-x-4">
              <a href="{{ route('customer_dash') }}" 
                 class="rounded-md px-3 py-2 text-sm font-medium {{ Request::routeIs('customer_dash') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}" 
                 aria-current="{{ Request::routeIs('customer_dash') ? 'page' : '' }}">Dashboard</a>
              
             

              <a href="{{ route('customer_transactions') }}" 
                 class="rounded-md px-3 py-2 text-sm font-medium {{ Request::routeIs('customer_transactions') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}" 
                 aria-current="{{ Request::routeIs('admin_transactions') ? 'page' : '' }}">My Transactions</a>
            </div>
          </div>
